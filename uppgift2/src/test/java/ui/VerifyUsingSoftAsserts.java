...
public class VerifyUsingSoftAsserts {
	...
	//	driver.manage().timeouts().pageLoadTimeout(30,TimeUnit.SECONDS);
		...
		String actualtext = driver.findElement(By.linkText("Upload")). getText(); 
		System.out.println("Verifying text" + actualtext );
		//softassert.assertEquals(actualtitle, expectedtitle, actualtitle); 
